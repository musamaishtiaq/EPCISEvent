...
namespace EPCISEvent.Controllers
{
    public class CompanyTypesController : Controller
    {
        ...
        public CompanyTypesController(MasterDataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Identifier,Description")] CompanyType companyType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Identifier,Description")] CompanyType companyType)
        {
